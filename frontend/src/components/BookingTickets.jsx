...
const handleBooking=async (e)=>{
    ...
    <div className="containers">
        ...
        <div className="ticket-info">
          ...
          <p>Phase 1 | Fanpit</p>
          <p><span id="ticket-count-text">{seats}</span>tickets</p>
        </div>
        ...
        <button type="submit" className="btn-primary" onClick={handleAddCart}>ADD TO CART</button>
              </>
        ) : (
              <>
    <h2>Order Summary</h2>
        <form method="post" id="booking-form">
            ...
            <div className="offers" tabIndex="0" onClick={() => alert('Show all event offers')}>
            View all event offers <i className="fas fa-chevron-right"></i>
            </div>
            <div className="payment-details">
            <div>
                <span>Order Amount</span>
                <span>₹<span id="order-amount">{seats * events.event_price}</span></span>
            </div>
            <div>
            ...
            <div className="total">
                ...
                <span>₹<span id="order-total">{TotalPrice}</span></span>
            </div>
            </div>
            <button type="submit" className="btn-primary" onClick={handleBooking}>CONTINUE</button>
        </form>
       </>
        )}
    </div>
